...
# RRT, with the extend() function carrying the modular sub-block including:
# steer() and nearest_node() functions as well as and goal checking.
# So that we can extend the vanilla RRT to bidirectional and other variants...!
...
class RRT:
    ...
    def plan(self):
        ...
        for i in range(0, self.max_iteration):
            ...
            # Steps 4-7 are part of extend() function (compared to RRT_v1).
            goal_reached, new_node = self.extend(random_node)
            if goal_reached:
